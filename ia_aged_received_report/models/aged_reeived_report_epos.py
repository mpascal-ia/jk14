...
class report_account_aged_partner(models.AbstractModel):
    ...
    _description = "Add the EPOS in report"
    ...
    def _get_columns_name(self, options):
        ...
        columns += [
            ...
            for v in [_("JRNL"), _("Account"), _("EPOS INVOICE"),_("Reference"), _("Not due on: %s") % format_date(self.env, options['date']['date']),
                ...
                for line in amls[values['partner_id']]:
                    ...
                    vals = {
                        ...
                        'columns': [{'name': v} for v in
                                    [aml.journal_id.code, aml.account_id.code, aml.invoice_id.x_studio_epos_invoice_id,
